...
namespace Model {
    public class Simulation {
        ...
        /// <summary>
        /// Initialiser for the Simulation class
        /// </summary>
        /// <param name="angleOfImpact"></param>
        /// <param name="ForceOnCar"></param>
        ...
        /// <summary>
        /// Starts a simulation with the properties set
        /// </summary>
        /// <returns>
        /// Chance of a collision 0 -> 1
        /// </returns>
        public float Start() {
            if (Velocity == 0) {
                Velocity = 1;
